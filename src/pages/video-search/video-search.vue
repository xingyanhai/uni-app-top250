<template>
    <view class="wrap">
        <view class="main-top">
            ...
            <view class="app-tips" v-if="config && config.searchNotice">{{config.searchNotice}}</view>
        ...
        <view class="main-bottom">
            ...
            <view class="bottom-ad-box" v-if="config && config.showAd">
                <ad-custom v-if="config && config.showAd" unit-id="adunit-f1376a5f253c11b3"></ad-custom>
            </view>
        </view>
    </view>
</template>
...
<script>
    ...
    export default {
            ...
            createRewardedVideoAd () {
                ...
                if (wx.createRewardedVideoAd && this.config && this.config.showAd && !this.videoAd) {
                    this.videoAd = wx.createRewardedVideoAd({
                        adUnitId: 'adunit-bba649702bc4cf3a'
                    })
                    this.videoAd.onLoad(() => {
                    })
        ...
        onShow() {
            ...
            let s = wx.getStorageSync('search')
            if (s) {
                this.search = s
                this.searchClick()
